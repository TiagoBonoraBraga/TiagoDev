...
export default function SecondHeader() {
    return (
        <>
            <div className="flex flex-col justify-center text-center z-0 py-10 px-6 w-5/6 bg-gray-100 rounded-lg p-8 shadow-md shadow-blue-100 hover:shadow-lg hover:shadow-blue-100 transition duration-300 ease-in-out transform hover:-translate-y-1 dark:shadow-gray-100">
