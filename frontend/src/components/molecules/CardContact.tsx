...
export default function CardContact({ contact }: CardContactProps) {
  ...
  return (
    <div>
      <section className="flex flex-col justify-start items-start w-auto p-5 rounded ring-2 gap-5 tracking-wider dark:bg-gray-200 ring-blue-200 text-white-500 mt-20 ss:gap-0  ss:flex ss:flex-col ss:justify-center ss:items-center ">
